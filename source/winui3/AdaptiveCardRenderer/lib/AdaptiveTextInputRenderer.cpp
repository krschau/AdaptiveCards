...
namespace winrt::AdaptiveCards::Rendering::XamlRendering::implementation
{
    std::tuple<winrt::UIElement, winrt::Border> AdaptiveTextInputRenderer::HandleLayoutAndValidation(
        ...
        winrt::AdaptiveCards::Rendering::XamlRendering::AdaptiveRenderContext const& renderContext,
        winrt::AdaptiveCards::Rendering::XamlRendering::AdaptiveRenderArgs const& renderArgs)
    {
        ...
        // ::AdaptiveCards::Rendering::XamlRendering::XamlHelpers::HandleInputLayoutAndValidation validation border because that
        ...
        {
            validationBorder = ::AdaptiveCards::Rendering::XamlRendering::XamlHelpers::CreateValidationBorder(inputUIElement, renderContext);
        ...
        if (inlineAction)
        {
            ...
            textBoxParentContainer = ::AdaptiveCards::Rendering::XamlRendering::ActionHelpers::HandleInlineAction(
        ...
        // Call  ::AdaptiveCards::Rendering::XamlRendering::XamlHelpers::HandleInputLayoutAndValidation to handle accessibility
                                                              ...
                                                              winrt::AdaptiveRenderArgs const& renderArgs)
    {
        ...
        ::AdaptiveCards::Rendering::XamlRendering::XamlHelpers::SetStyleFromResourceDictionary(renderContext, L"Adaptive.Input.Text", textBox);
