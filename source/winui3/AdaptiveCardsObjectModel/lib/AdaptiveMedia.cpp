...
namespace winrt::AdaptiveCards::ObjectModel::Winui3::implementation
{
    AdaptiveMedia::AdaptiveMedia(const std::shared_ptr<::AdaptiveCards::Media>& sharedMedia)
    {
        ...
        CaptionSources = GenerateVectorProjection<winrt::AdaptiveCards::ObjectModel::Winui3::implementation::AdaptiveCaptionSource>(sharedMedia->GetCaptionSources());
    ...
    std::shared_ptr<::AdaptiveCards::BaseCardElement> AdaptiveMedia::GetSharedModel()
    {
        ...
        media->GetCaptionSources() =
            GenerateSharedVector<winrt::AdaptiveCards::ObjectModel::Winui3::implementation::AdaptiveCaptionSource, ::AdaptiveCards::CaptionSource>(CaptionSources.get());
