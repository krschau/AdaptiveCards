...
namespace winrt::AdaptiveCards::Rendering::XamlRendering::implementation
{
    AdaptiveCardRenderer::AdaptiveCardRenderer() :
        ...
        m_xamlBuilder(winrt::make_self<::AdaptiveCards::Rendering::XamlRendering::XamlBuilder>())
    {
        ::AdaptiveCards::Rendering::XamlRendering::RegisterDefaultElementRenderers(m_elementRendererRegistration.get(), m_xamlBuilder);
        ::AdaptiveCards::Rendering::XamlRendering::RegisterDefaultActionRenderers(m_actionRendererRegistration.get());
        InitializeDefaultResourceDictionary();
        UpdateActionSentimentResourceDictionary();
    }

    XamlRendering::AdaptiveFeatureRegistration AdaptiveCardRenderer::FeatureRegistration()
    {
    ...
    XamlRendering::RenderedAdaptiveCard AdaptiveCardRenderer::RenderAdaptiveCard(winrt::AdaptiveCard const& adaptiveCard)
    {
        ...
        if (adaptiveCard)
        {
            ...
            try
            {
                ...
                auto xamlTreeRoot =
                    ::AdaptiveCards::Rendering::XamlRendering::XamlBuilder::BuildXamlTreeFromAdaptiveCard(adaptiveCard,
                                                                                                *renderContext,
                                                                                                m_xamlBuilder.get());
    ...
    XamlRendering::RenderedAdaptiveCard AdaptiveCardRenderer::RenderAdaptiveCardFromJsonString(hstring const& adaptiveJson)
    {
    ...
    XamlRendering::RenderedAdaptiveCard AdaptiveCardRenderer::RenderAdaptiveCardFromJson(winrt::JsonObject const& adaptiveJson)
    {
